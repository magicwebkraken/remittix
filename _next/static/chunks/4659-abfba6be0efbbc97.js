  ...
  [4659],
  {
        ...
        function update() {
              ...
              (n.dynamicBullets &&
                ...
                d.forEach((e) => {
                  e.style[i.isHorizontal() ? "width" : "height"] = `${
                    t * (n.dynamicMainBullets + 4)
                  }px`;
                }),
                n.dynamicMainBullets > 1 &&
                  void 0 !== s &&
                  ((o += e - (s || 0)) > n.dynamicMainBullets - 1
              ...
              u.forEach((t) => {
                ...
                s === e
                  ...
                  n.dynamicBullets &&
                    ...
                    s === l && setSideBullets(t, "prev"),
                    s === p && setSideBullets(t, "next"));
              });
            else {
              let t = u[e];
              if (
          ...
          d.forEach((t, s) => {
            if (
              ("fraction" === n.type &&
                ...
                t
                  ...
                  .forEach((e) => {
                    e.textContent = n.formatFractionTotal(c);
                  })),
              "progressbar" === n.type)
            ) {
              let s;
            ...
            "custom" === n.type && n.renderCustom
              ? ((t.innerHTML = n.renderCustom(i, e + 1, c)),
      ...
      function Autoplay(e) {
        ...
        function onTransitionEnd(e) {
          u &&
            ...
            (u.wrapperEl.removeEventListener("transitionend", onTransitionEnd),
            !c && (!e.detail || !e.detail.bySwiperTouchMove) && resume());
        }
        let calcTimeLeft = () => {
          ...
          pause = (e, i) => {
            ...
            if (((u.autoplay.paused = !0), i)) {
              d && (r = u.params.autoplay.delay), (d = !1), proceed();
              return;
            }
            let s = r || u.params.autoplay.delay;
            (r = s - (new Date().getTime() - b)),
          ...
          onVisibilityChange = () => {
            if (u.destroyed || !u.autoplay.running) return;
            let e = (0, s.g)();
            "hidden" === e.visibilityState && ((p = !0), pause(!0)),
          ...
          onPointerEnter = (e) => {
            "mouse" === e.pointerType &&
              ((p = !0),
              (c = !0),
              u.animating || u.autoplay.paused || pause(!0));
          },
          onPointerLeave = (e) => {
            "mouse" === e.pointerType &&
              ((c = !1), u.autoplay.paused && resume());
          },
          attachMouseEvents = () => {
            u.params.autoplay.pauseOnMouseEnter &&
              (u.el.addEventListener("pointerenter", onPointerEnter),
              u.el.addEventListener("pointerleave", onPointerLeave));
          },
          detachMouseEvents = () => {
            u.el &&
              "string" != typeof u.el &&
              (u.el.removeEventListener("pointerenter", onPointerEnter),
              u.el.removeEventListener("pointerleave", onPointerLeave));
          },
        ...
        m("init", () => {
          u.params.autoplay.enabled &&
            (attachMouseEvents(), attachDocumentEvents(), start());
        }),
          m("destroy", () => {
            detachMouseEvents(),
              detachDocumentEvents(),
              u.autoplay.running && stop();
          }),
          m("_freeModeStaticRelease", () => {
            (n || p) && resume();
          }),
          m("_freeModeNoMomentumRelease", () => {
            u.params.autoplay.disableOnInteraction ? stop() : pause(!0, !0);
          }),
          m("beforeTransitionStart", (e, t, i) => {
            !u.destroyed &&
              u.autoplay.running &&
              (i || !u.params.autoplay.disableOnInteraction
                ? pause(!0, !0)
                : stop());
          }),
          m("sliderFirstMove", () => {
          ...
          m("touchEnd", () => {
            if (!u.destroyed && u.autoplay.running && l) {
              ...
              n && u.params.cssMode && resume(), (n = !1), (l = !1);
            }
          }),
          m("slideChange", () => {
            !u.destroyed && u.autoplay.running && (d = !0);
          }),
          Object.assign(u.autoplay, { start, stop, pause, resume });
      }
      function Grid(e) {
        let t,
          i,
          s,
          r,
          { swiper: a, extendParams: l, on: n } = e;
        ...
        n("init", () => {
          ...
          (a.grid = {
            initSlides: (e) => {
              let { slidesPerView: r } = a.params,
                { rows: l, fill: n } = a.params.grid,
                o =
            ...
            updateSlide: (e, r, l) => {
              let n, o, d;
              let { slidesPerGroup: p } = a.params,
                c = getSpaceBetween(),
                { rows: u, fill: h } = a.params.grid,
                m =
                  a.virtual && a.params.virtual.enabled
                    ? a.virtual.slides.length
                    : l.length;
              if ("row" === h && p > 1) {
                let i = Math.floor(e / (p * u)),
                  s = e - u * p * i,
                  a = 0 === i ? p : Math.min(Math.ceil((m - i * u * p) / u), p);
                (d = Math.floor(s / a)),
                  (n = (o = s - d * a + i * p) + (d * t) / u),
                  (r.style.order = n);
              } else
            ...
            updateWrapperSize: (e, i) => {
              let { centeredSlides: s, roundLengths: r } = a.params,
                l = getSpaceBetween(),
                { rows: n } = a.params.grid;
              if (
                ((a.virtualSize = (e + l) * t),
                (a.virtualSize = Math.ceil(a.virtualSize / n) - l),
                a.params.cssMode ||
    ...
    2261: function (e, t, i) {
      ...
      function onTouchStart(e) {
        ...
        let m = a.currentX,
          f = a.currentY;
        if (!preventEdgeSwipe(this, i, m)) return;
        Object.assign(s, {
          isTouched: !0,
          isMoved: !1,
      ...
      function onTouchEnd(e) {
        ...
        if (m > n.longSwipesMs) {
          ...
          "next" === s.swipeDirection &&
            (y >= n.longSwipesRatio
              ? s.slideTo(n.rewind && s.isEnd ? w : g + S)
              : s.slideTo(g)),
          ...
          e
            ? a.target === s.navigation.nextEl
              ? s.slideTo(g + S)
              : s.slideTo(g)
            : ("next" === s.swipeDirection && s.slideTo(null !== w ? w : g + S),
      ...
      let p = {
          ...
          update: {
            ...
            updateSlides: function () {
              ...
              let i = t.params,
                ...
                c = (0, o.e)(r, `.${t.params.slideClass}, swiper-slide`),
              ...
              x ? t.grid.initSlides(c) : t.grid && t.grid.unsetSlides();
              let C =
              ...
              for (let s = 0; s < u; s += 1) {
                ...
                if (
                  ((e = 0),
                  c[s] && (r = c[s]),
                  x && t.grid.updateSlide(s, r, c),
                  !c[s] || "none" !== (0, o.p)(r, "display"))
                ) {
                  if ("auto" === i.slidesPerView) {
                    C && (c[s].style[t.getDirectionLabel("width")] = "");
                    ...
                    (e = (a - (i.slidesPerView - 1) * y) / i.slidesPerView),
                      i.roundLengths && (e = Math.floor(e)),
                      c[s] &&
                        (c[s].style[t.getDirectionLabel("width")] = `${e}px`);
            ...
            updateSlidesProgress: function (e) {
              ...
              for (let e = 0; e < i.length; e += 1) {
                ...
                m &&
                  ...
                  toggleSlideClasses$1(n, m, t.slideVisibleClass),
                  toggleSlideClasses$1(n, h, t.slideFullyVisibleClass),
                  (n.progress = s ? -d : d),
          ...
          loop: {
            ...
            loopFix: function (e) {
              ...
              let T = "next" === s || !s,
                ...
                C = 0,
                M = 0,
                P = b ? Math.ceil(p.length / m.grid.rows) : p.length,
                L = b ? p[a].column : a,
                O = L + (f && void 0 === r ? -g / 2 + 0.5 : 0);
              if (O < w) {
                C = Math.max(w - O, v);
              ...
              if (
                ...
                if (y.length > 0 && x) {
                  ...
                  if (void 0 === t) {
                    ...
                    let e = b ? S.length / m.grid.rows : S.length;
                    d.slideTo(d.activeIndex - e, 0, !1, !0);
                  }
                }
              }
          ...
          breakpoints: {
            setBreakpoint: function () {
              ...
              let f = d.direction && d.direction !== s.direction,
                g = s.loop && (d.slidesPerView !== s.slidesPerView || f),
                v = s.loop;
              f && i && e.changeDirection(), (0, o.w)(e.params, d);
        ...
        f = (0, l.forwardRef)(function (e, t) {
          ...
          return (
            ...
            (0, l.useEffect)(() => {
              !y.current &&
                E.current &&
                (E.current.emitSlidesClasses(), (y.current = !0));
            }),
            useIsomorphicLayoutEffect(() => {
              if ((t && (t.current = S.current), S.current))
                return (
                  ...
                  o && !E.current.destroyed && o(E.current),
                  () => {
                    E.current &&
                      !E.current.destroyed &&
            ...
            useIsomorphicLayoutEffect(() => {
              ...
              })(k, T.current, z, x.current, (e) => e.key);
              return (
                (T.current = k),
                (x.current = z),
                e.length &&
                    ...
                    if (
                      (u.includes("loop") &&
                        ...
                        (w.loop && !c.loop
                          ...
                          : (o = !0)),
                      v.forEach((e) => {
                        if (isObject(w[e]) && isObject(c[e]))
                          Object.assign(w[e], c[e]),
                            ("navigation" === e ||
                              "pagination" === e ||
                              "scrollbar" === e) &&
                              "enabled" in c[e] &&
                      ...
                      u.includes("children") && p && E && w.virtual.enabled
                        ? ((E.slides = p), E.update(!0))
                        : u.includes("virtual") &&
                          E &&
                          w.virtual.enabled &&
                          (p && (E.slides = p), E.update(!0)),
                      u.includes("children") && p && w.loop && (o = !0),
                      t)
                    ) {
                      let e = T.init();
                      e && T.update(!0);
            ...
            l.createElement(
              r,
              _extends(
                { ref: S, className: uniqueClasses(`${h}${s ? ` ${s}` : ""}`) },
                _
              ),
              l.createElement(
                m.Provider,
                ...
                l.createElement(
                  a,
                  {
                    className: (void 0 === (i = O.wrapperClass) && (i = ""), i)
